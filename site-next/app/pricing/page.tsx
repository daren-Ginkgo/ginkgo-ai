...
export default function PricingPage() {
  return <main id="main-content"><SiteHeader />
    <section className="pricing-page-hero"><div className="shell"><span className="kicker light">Clear firm pricing</span><h1>Simple pricing.{" "}<br />A valuable founding offer.</h1><p>Standard pricing runs from £200 per adviser per month. Fifteen individual Quilter advisers can join the pre-launch beta free of charge.</p></div></section>
